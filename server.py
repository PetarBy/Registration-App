...
class Handler(BaseHTTPRequestHandler):
    ...
    def serve_static(self):
        # Map URL /static/... to filesystem static/... 
        rel_path = self.path[len('/'):].lstrip('/')
    ...
    def show_register(self):
        return send_html(self, 200, render('register.html'))
    ...
    def handle_login(self):
        ...
        try:
            ...
            if row and check_password(row['password_hash'], password):
                ...
                cur.execute(
                    "INSERT INTO sessions (session_id, user_id, expires) VALUES (%s, %s, %s)",
